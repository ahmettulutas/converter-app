...
export function ComboBoxResponsive(props: Readonly<ComboboxProps>) {
  const { title, data, triggerProps, value, handleChange, emptyMessage, icon } = props;
    ...
    return (
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="p-0" align="end">
          <ComboItems setSelected={onChange} setOpen={setOpen} data={data} emptyMessage={emptyMessage} />
        </PopoverContent>
      </Popover>
    );
  }
